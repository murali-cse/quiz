    ...
    <div class="container">
        <div style="text-align:center">
            <div class="row h-100 justify-content-center align-items-center">
                <div class="col-sm-12 col-xs-12 col-md-12 col-lg-6 welcome-card" style="padding:7%">
                    <h3>Admin Register</h3>
                    <form action="<?php echo base_url('register/admin_register') ?>" method="post">
                        <div class="row mt-3">
                    ...
                    <h6>Already have an account ? <span> <a
                                href="<?php echo base_url('login/admin') ?>">Login</a></span>
                    </h6>
                </div>
            </div>
        </div>
